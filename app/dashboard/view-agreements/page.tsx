...
export default function ViewAgreementsPage() {
  ...
  const agreementsList = [
    ...
    },
    {
      ...
      content: "Injury & Disease Release Waiver:\n\nI understand that while my dog is in attendance at Aldenham Doggy Day Care, my dog will be socializing and playing with other dogs. I understand that during the course of normal dog play, my dog may sustain injuries.\n\nAll dogs attending Aldenham Doggy Day Care must be in good health. If my dog shows any symptoms of illness, I will not bring my dog to the facility.\n\nI understand that despite all precautions taken by Aldenham Doggy Day Care, there is a risk that my dog may be exposed to or contract diseases from other dogs.\n\nI hereby release and hold harmless Aldenham Doggy Day Care, its owners, employees, and agents from any and all liability, claims, suits, actions, loss, or injury to my dog, or myself, arising from normal dog play during my dog's attendance at Aldenham Doggy Day Care."
    },
    {
    ...
    },
    {
      ...
      content: "Property Damage Liability Waiver:\n\nI understand that my dog will be in a facility with equipment, furniture, and property belonging to Aldenham Doggy Day Care and other clients.\n\nI agree that:\n• I am responsible for any damage my dog causes to Aldenham Doggy Day Care property, equipment, or facilities\n• I am responsible for any damage my dog causes to property belonging to other clients\n• I will pay for repairs or replacement of damaged items within 30 days of being notified\n• Aldenham Doggy Day Care may suspend services until damages are paid\n\nAldenham Doggy Day Care agrees to:\n• Provide reasonable supervision to prevent property damage\n• Notify me promptly of any damage caused by my dog\n• Provide itemized estimates for repair or replacement costs\n\nI release Aldenham Doggy Day Care from liability for damage to any personal items I choose to send with my dog (toys, bedding, collars, etc.). I understand that personal items may be lost, damaged, or destroyed during normal play."
    },
    {
