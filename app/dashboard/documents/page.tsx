      ...
      <div className="min-h-screen bg-gradient-to-br from-canine-cream via-white to-canine-sky flex items-center justify-center">
        <div className="text-center">
          <div className="relative">
            ...
            <DocumentSolid className="h-6 w-6 text-canine-gold absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" />
          </div>
        ...
        >
          ...
          <div className="mb-8">
            <DashboardHeader
              ...
              subtitle="Manage vaccination records and important documents"
            />
            ...
            <motion.div
              initial={{ scale: 0.95 }}
              animate={{ scale: 1 }}
              className="relative bg-gradient-to-r from-canine-navy via-canine-navy/90 to-canine-navy rounded-3xl shadow-2xl p-8 mb-6 overflow-hidden"
            >
              <motion.div
                animate={{ rotate: 360 }}
              ...
              >
                <DocumentSolid className="h-40 w-40 text-canine-gold" />
              </motion.div>
              <motion.div
              ...
              >
                <CheckBadgeIcon className="h-32 w-32 text-canine-gold" />
              </motion.div>

              <div className="relative z-10">
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div className="flex items-center gap-4">
                    <div className="bg-canine-gold/20 backdrop-blur-sm rounded-2xl p-4">
                    ...
                    <div>
                      ...
                      <p className="text-canine-gold text-lg mt-1">
                  ...
                  <motion.button
                    ...
                    className="bg-canine-gold text-white px-6 py-3 rounded-xl font-bold shadow-xl hover:bg-canine-light-gold hover:shadow-2xl flex items-center gap-2 transition-colors"
                  >
            ...
            {groupedDocs.map((group, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-6 pb-6 border-b-2 border-canine-gold/20">
                  <div className="w-16 h-16 rounded-full bg-gradient-to-br from-canine-gold to-canine-light-gold flex items-center justify-center shadow-lg border-2 border-canine-gold/30">
                    {group.dog.photo_url ? (
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-display font-bold text-canine-navy">{group.dog.name}</h2>
                    <p className="text-gray-600">{group.dog.breed}</p>
                  </div>
                  <div className="bg-canine-cream rounded-xl px-4 py-2 border border-canine-gold/30">
                    <p className="text-sm text-canine-navy font-semibold">{group.docs.length} Documents</p>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {group.docs.map((doc, docIndex) => (
                      <motion.div
                        ...
                        className="bg-gradient-to-br from-canine-cream to-canine-sky/30 rounded-xl p-4 border border-canine-gold/20 hover:border-canine-gold transition-all shadow-lg hover:shadow-xl"
                      >
                        <div className="flex items-start gap-3 mb-3">
                          <div className="bg-canine-navy rounded-lg p-2">
                            <DocumentCheckIcon className="h-6 w-6 text-canine-gold" />
                          </div>
                          <div className="flex-1 min-w-0">
                            <p className="font-bold text-canine-navy truncate">{doc.file_name}</p>
                        ...
                        <div className="flex items-center gap-2">
                          <a
                            ...
                            className="flex-1 bg-canine-gold hover:bg-canine-light-gold text-white px-3 py-2 rounded-lg text-sm font-semibold flex items-center justify-center gap-1 transition-colors"
                          >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="bg-canine-navy rounded-xl p-2">
                  <CloudArrowUpIcon className="h-6 w-6 text-canine-gold" />
                </div>
                <h2 className="text-2xl font-display font-bold text-canine-navy">Upload Document</h2>
              </div>
              <motion.button
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-canine-gold focus:outline-none transition-colors"
                >
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-canine-gold focus:outline-none transition-colors file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-canine-cream file:text-canine-navy file:font-semibold hover:file:bg-canine-sky"
                />
              ...
              {uploadFile && (
                <div className="bg-canine-cream border border-canine-gold/30 rounded-xl p-3">
                  <div className="flex items-center gap-2">
                    <CheckCircleIcon className="h-5 w-5 text-canine-gold" />
                    <span className="text-sm text-canine-navy font-medium truncate">
                      {uploadFile.name}
                    </span>
                  </div>
                </div>
              ...
              <div className="flex gap-3 pt-4">
                ...
                <motion.button
                  ...
                  className="flex-1 bg-canine-gold hover:bg-canine-light-gold text-white px-4 py-3 rounded-xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-all shadow-lg"
                >
                  {uploading ? (
                    <>
                      <motion.div
