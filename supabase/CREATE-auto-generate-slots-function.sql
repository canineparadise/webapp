-- ============================================
-- AUTO-GENERATE ASSESSMENT SLOTS FUNCTION
-- ============================================
-- This function generates dated assessment slots from recurring templates

-- Drop existing function if it exists
DROP FUNCTION IF EXISTS generate_assessment_slots_from_recurring();
...
BEGIN
  ...
  LOOP
    ...
    FOR week_offset IN 0..(weeks_ahead - 1) LOOP
      ...
      -- Only create if date is in future and slot doesn't already exist
...
-- Add max_dogs column to recurring slots if it doesn't exist
ALTER TABLE assessment_recurring_slots
ADD COLUMN IF NOT EXISTS max_dogs INTEGER DEFAULT 6;

-- Test the function (generate slots for next 4 weeks)
