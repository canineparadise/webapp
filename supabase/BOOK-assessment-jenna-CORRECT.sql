-- =====================================================
-- BOOK ASSESSMENT FOR JENNA - CORRECT VERSION
-- =====================================================
...
SELECT id, assessment_date, start_time, end_time, max_dogs, booked_count, is_available
...
-- Step 6: Update the slot's booked_count
...
BEGIN
  ...
  RAISE NOTICE '  3. Run Step 3 to create the slot';
  RAISE NOTICE '  4. Run Step 4 to get the slot_id - copy it';
  RAISE NOTICE '  5. In Step 5, replace SLOT_ID_HERE and DOG_ID_HERE';
  RAISE NOTICE '  6. Run Step 5 to create the booking';
  RAISE NOTICE '  7. Run Step 6 to update booking count';
  RAISE NOTICE '  8. Run Step 7 to update the dog record';
